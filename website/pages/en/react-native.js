...
class HomeSplash extends React.Component {
  render() {
    ...
    const ProjectTitle = () => (
      <div>
        <h2 className="projectTitle">Native Testing Library</h2>
        <div className="projectTaglineWrapper">
          <p className="projectTagline">
            Simple and complete React Native testing utilities that encourage
    ...
    return (
      <SplashContainer>
        ...
        <div className="inner">
          ...
          <PromoSection>
            <Button
              href={'https://www.native-testing-library.com/docs/intro'}
              target="_blank"
            >
              Read the Docs
            </Button>
        ...
        {[
          {
            ...
            content:
              '## The Solution \n `native-testing-library` is a very light-weight solution for testing React Native apps. It provides utility functions that encourage better testing practices. Its primary guiding principle is: \n > The more your tests resemble the way your software is used, the more confidence they can give you.',
          },
        ]}
      </Block>
    )
      ...
      <React.Fragment>
        <Block layout="twoColumn">
          {[
            ...
            {
              content:
                '`native-testing-library` is an opinionated alternative to libraries like Enzyme that provide too many ways to avoid testing like a user',
