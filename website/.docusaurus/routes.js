...
{
  path: '/search',
  component: ComponentCreator('/search','485'),
  exact: true,
},
{
  path: '/users',
...
},
{
  ...
  component: ComponentCreator('/docs/angular-testing-library/examples','26f'),
  exact: true,
},
{
  path: '/docs/angular-testing-library/intro',
  component: ComponentCreator('/docs/angular-testing-library/intro','e40'),
  exact: true,
},
{
  path: '/docs/bs-react-testing-library/examples',
  component: ComponentCreator('/docs/bs-react-testing-library/examples','40c'),
  exact: true,
},
{
  path: '/docs/bs-react-testing-library/intro',
  component: ComponentCreator('/docs/bs-react-testing-library/intro','16f'),
  exact: true,
},
{
...
},
{
  ...
  component: ComponentCreator('/docs/cypress-testing-library/intro','dcc'),
  exact: true,
},
{
  path: '/docs/dom-testing-library/api-async',
  component: ComponentCreator('/docs/dom-testing-library/api-async','914'),
  exact: true,
},
{
  path: '/docs/dom-testing-library/api-configuration',
  component: ComponentCreator('/docs/dom-testing-library/api-configuration','9df'),
  exact: true,
},
{
  path: '/docs/dom-testing-library/api-events',
  component: ComponentCreator('/docs/dom-testing-library/api-events','45b'),
  exact: true,
},
{
  path: '/docs/dom-testing-library/api-helpers',
  component: ComponentCreator('/docs/dom-testing-library/api-helpers','26d'),
  exact: true,
},
{
  path: '/docs/dom-testing-library/api-queries',
  component: ComponentCreator('/docs/dom-testing-library/api-queries','b86'),
  exact: true,
},
{
  path: '/docs/dom-testing-library/cheatsheet',
  component: ComponentCreator('/docs/dom-testing-library/cheatsheet','a34'),
  exact: true,
},
{
  path: '/docs/dom-testing-library/example-intro',
  component: ComponentCreator('/docs/dom-testing-library/example-intro','ce4'),
  exact: true,
},
{
...
},
{
  ...
  component: ComponentCreator('/docs/ecosystem-eslint-plugin-jest-dom','c8d'),
  exact: true,
},
{
  path: '/docs/ecosystem-eslint-plugin-testing-library',
  component: ComponentCreator('/docs/ecosystem-eslint-plugin-testing-library','7ba'),
  exact: true,
},
{
...
},
{
  ...
  component: ComponentCreator('/docs/ecosystem-react-select-event','079'),
  exact: true,
},
{
  path: '/docs/ecosystem-riot-testing-library',
  component: ComponentCreator('/docs/ecosystem-riot-testing-library','dd1'),
  exact: true,
},
{
...
},
{
  ...
  component: ComponentCreator('/docs/example-react-hooks-useReducer','7df'),
  exact: true,
},
{
...
},
{
  ...
  component: ComponentCreator('/docs/example-react-transition-group','6e6'),
  exact: true,
},
{
...
},
{
  ...
  component: ComponentCreator('/docs/nightwatch-testing-library/intro','6b1'),
  exact: true,
},
{
...
},
{
  ...
  component: ComponentCreator('/docs/preact-testing-library/example','a8d'),
  exact: true,
},
{
  path: '/docs/preact-testing-library/intro',
  component: ComponentCreator('/docs/preact-testing-library/intro','629'),
  exact: true,
},
{
  path: '/docs/preact-testing-library/learn',
  component: ComponentCreator('/docs/preact-testing-library/learn','b25'),
  exact: true,
},
{
  path: '/docs/react-native-testing-library/example-intro',
  component: ComponentCreator('/docs/react-native-testing-library/example-intro','2fb'),
  exact: true,
},
{
  path: '/docs/react-native-testing-library/intro',
  component: ComponentCreator('/docs/react-native-testing-library/intro','735'),
  exact: true,
},
{
  path: '/docs/react-native-testing-library/setup',
  component: ComponentCreator('/docs/react-native-testing-library/setup','4bd'),
  exact: true,
},
{
...
},
{
  ...
  component: ComponentCreator('/docs/react-testing-library/cheatsheet','2a0'),
  exact: true,
},
{
  path: '/docs/react-testing-library/example-intro',
  component: ComponentCreator('/docs/react-testing-library/example-intro','429'),
  exact: true,
},
{
...
},
{
  ...
  component: ComponentCreator('/docs/react-testing-library/migrate-from-enzyme','f56'),
  exact: true,
},
{
...
},
{
  ...
  component: ComponentCreator('/docs/svelte-testing-library/example','601'),
  exact: true,
},
{
  path: '/docs/svelte-testing-library/intro',
  component: ComponentCreator('/docs/svelte-testing-library/intro','572'),
  exact: true,
},
{
  path: '/docs/svelte-testing-library/setup',
  component: ComponentCreator('/docs/svelte-testing-library/setup','4d1'),
  exact: true,
},
{
  path: '/docs/testcafe-testing-library/intro',
  component: ComponentCreator('/docs/testcafe-testing-library/intro','b8b'),
  exact: true,
},
{
...
},
{
  ...
  component: ComponentCreator('/docs/vue-testing-library/cheatsheet','a79'),
  exact: true,
},
{
  path: '/docs/vue-testing-library/examples',
  component: ComponentCreator('/docs/vue-testing-library/examples','4f0'),
  exact: true,
},
{
