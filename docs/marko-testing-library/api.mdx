...
:::tip The [cleanup](#cleanup) function should be called between tests to remove
the created DOM nodes and keep the tests isolated. :::
...
:::caution If you find yourself using `container` to query for rendered elements
then you should reconsider! The other queries are designed to be more resilient
to changes that will be made to the component you're testing. Avoid using
