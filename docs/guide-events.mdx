...
If an element is focused, a focus event is dispatched, the active element 
in the document changes, and the previously focused element is blurred. 
To simulate this behavior you can simply replace `fireEvent`
