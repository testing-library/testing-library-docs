...
utility for easily dispatching events. It dispatches exactly, and only, the events you tell it
to - even if those exact events would not have been dispatched in a
