...
specific element, you can use
[`within`](dom-testing-library/api-helpers.mdx#within-and-getqueriesforelement-apis).
If necessary, there are also a few options you can
