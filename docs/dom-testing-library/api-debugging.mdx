...
Built on top of
[`pretty-format`](https://github.com/facebook/jest/tree/main/packages/pretty-format),
...
[options](https://github.com/facebook/jest/tree/main/packages/pretty-format#usage-with-options)
of `pretty-format`.
