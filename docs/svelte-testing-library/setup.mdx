...
Optionally install `@vitest/ui` open a UI within a browser window to view and
interact with your tests.
...
4. Optionally install [jest-dom](https://github.com/testing-library/jest-dom) to
