...
2. Add the test scipts to your `package.json` to run the tests with Vitest
...
3. To compile the Svelte components before using them in Vitest, you need to
   install
...
5. Optionally install [jest-dom](https://github.com/testing-library/jest-dom) to
   add handy assertions to Vitest
...
6. Create your component and a test file (checkout the rest of the docs to see
