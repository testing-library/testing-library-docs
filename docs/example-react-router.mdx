...
> **Note**
>
> If you are using react-router v5 you will need to install history ^4.9.0 for
> compatibility reasons. See [issue
> 869](https://github.com/testing-library/react-testing-library/issues/869) for
> details.
