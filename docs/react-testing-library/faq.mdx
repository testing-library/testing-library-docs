...
<summary>How do I use this library with typescript?</summary>

Types are included with Testing Library. You can follow the JavaScript examples from the documentation and refer the types from the installed package or the source code. For example, the types for React Testing Library can be found [here](https://github.com/testing-library/react-testing-library/blob/master/types/index.d.ts).
