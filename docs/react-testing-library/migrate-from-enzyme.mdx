...
- **[@testing-library/jest-dom](https://github.com/testing-library/jest-dom)**:
  ...
  Jest. These will make your tests more declarative, clearer to read, and easier
  to maintain.
...
Enzyme will need to be left behind (no more need for a `wrapper` variable or
...
different name, and the template will update accordingly. Check the live version
...
In the component above, the input values will be initialized with the
...
React Testing Library aims to test the components how users will use them. Users
...
React Testing Library exposes some handy query APIs which will help you access
