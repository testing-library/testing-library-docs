...
:::tip Projects created with [`Create React App`](https://create-react-app.dev/)
have out of the box support for **React Testing Library**. If that is not the
case, you can add it via `npm` like so: :::
...
:::info This library is built on top of
