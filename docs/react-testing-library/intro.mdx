...
You can also check out the free "React Testing Library" introduction course below.

<a href="https://www.youtube.com/watch?v=mk_nDTS39MY&list=PLG-Mk4wQm9_I-BwnYyXiNPvHJBqq0X-1C&index=1">
  <img
    width="200px"
    alt="react testing library course"
    src="https://i.imgur.com/XaOe0oi.jpeg"
    style={{ marginLeft: 0 }}
  />
</a>
